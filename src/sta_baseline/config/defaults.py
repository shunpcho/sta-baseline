...
# Pickled train file name
_C.EPIC_KITCHEN.MANIFOLD_TRAIN_DATA_LIST = "manifold://ondevice_ai_data/tree/datasets/epic/mini_train_action_labels.pkl"

# Pickled val file name
_C.EPIC_KITCHEN.MANIFOLD_TEST_DATA_LIST = "manifold://ondevice_ai_data/tree/datasets/epic/mini_test_action_labels.pkl"

# Video path prefix for all filename in the pickled files above
_C.EPIC_KITCHEN.MANIFOLD_TRAIN_PATH_PREFIX = "manifold://fair_vision_data/tree/epic/epic_frames_train"

_C.EPIC_KITCHEN.MANIFOLD_TEST_PATH_PREFIX = "manifold://fair_vision_data/tree/epic/epic_frames_test"
...
_C.EPIC_KITCHEN.STRIDE_TYPE = "constant"  # other options distribution ("norm", "lognorm", "uniform")
...
_C.EGO4D.MANIFOLD_VERB_LABELS_PATH = "manifold://ondevice_ai_data/tree/datasets/ego4d/verb_label.txt"

# path to the noun labels on manifold
_C.EGO4D.MANIFOLD_NOUN_LABELS_PATH = "manifold://ondevice_ai_data/tree/datasets/ego4d/noun_label.txt"
